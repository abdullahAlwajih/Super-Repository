final Map<String, String> errorAr = {
  ...
  'Error:UserExistsException':
      'قد يكون هذا الحساب موجود مسبقاً! حاول تغيير رقم الهاتف او الايميل',
  'Error:PasswordException': 'كلمة المرور غير صحيحة',
  'Error:UnauthenticatedException': 'عذرا ! أنت غير مخول لهذه العملية',
  'Error:BlockedException':
      'عذرا ! لقد تم حظر حسابك. يرجى التواصل مع المسؤول لإزالة الحظر',
  'Error:UnexpectedException': 'عذراً حدث خطأ غير متوقع',
  'Error:ConflictException': 'تعذر إكمال الطلب بسبب وجود تعارض',
